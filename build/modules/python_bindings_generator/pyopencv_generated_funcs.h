...
static PyObject* pyopencv_cv_bmcpu_GaussianBlur(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    const char* keywords[] = { "_src", "ksize", "sigmaX", "_dst", "sigmaY", "borderType", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOd|Odi:bmcpu_GaussianBlur", (char**)keywords, &pyobj__src, &pyobj_ksize, &sigmaX, &pyobj__dst, &sigmaY, &borderType) &&
        pyopencv_to(pyobj__src, _src, ArgInfo("_src", 0)) &&
        pyopencv_to(pyobj__dst, _dst, ArgInfo("_dst", 1)) &&
        pyopencv_to(pyobj_ksize, ksize, ArgInfo("ksize", 0)) )
    {
        ERRWRAP2(cv::bmcpu_GaussianBlur(_src, _dst, ksize, sigmaX, sigmaY, borderType));
...
static PyObject* pyopencv_cv_bmcpu_Sobel(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    const char* keywords[] = { "src", "ddepth", "dx", "dy", "dst", "ksize", "scale", "delta", "borderType", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "Oiii|Oiddi:bmcpu_Sobel", (char**)keywords, &pyobj_src, &ddepth, &dx, &dy, &pyobj_dst, &ksize, &scale, &delta, &borderType) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
        ERRWRAP2(cv::bmcpu_Sobel(src, dst, ddepth, dx, dy, ksize, scale, delta, borderType));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_bilateralFilter(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    const char* keywords[] = { "src", "d", "sigmaColor", "sigmaSpace", "dst", "borderType", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "Oidd|Oi:bmcpu_bilateralFilter", (char**)keywords, &pyobj_src, &d, &sigmaColor, &sigmaSpace, &pyobj_dst, &borderType) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
        ERRWRAP2(cv::bmcpu_bilateralFilter(src, dst, d, sigmaColor, sigmaSpace, borderType));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_boxFilter(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OiO|OObi:bmcpu_boxFilter", (char**)keywords, &pyobj__src, &ddepth, &pyobj_ksize, &pyobj__dst, &pyobj_anchor, &normalize, &borderType) &&
        pyopencv_to(pyobj__src, _src, ArgInfo("_src", 0)) &&
        pyopencv_to(pyobj__dst, _dst, ArgInfo("_dst", 1)) &&
        pyopencv_to(pyobj_ksize, ksize, ArgInfo("ksize", 0)) &&
        pyopencv_to(pyobj_anchor, anchor, ArgInfo("anchor", 0)) )
    {
        ERRWRAP2(cv::bmcpu_boxFilter(_src, _dst, ddepth, ksize, anchor, normalize, borderType));
        return pyopencv_from(_dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_calcHist(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOO|Ob:bmcpu_calcHist", (char**)keywords, &pyobj_images, &pyobj_channels, &pyobj_mask, &pyobj_histSize, &pyobj_ranges, &pyobj_hist, &accumulate) &&
    ...
    {
        ERRWRAP2(cv::bmcpu_calcHist(images, channels, mask, hist, histSize, ranges, accumulate));
...
static PyObject* pyopencv_cv_bmcpu_calcOpticalFlowFarneback(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;

    {
    PyObject* pyobj__prev0 = NULL;
    Mat _prev0;
    PyObject* pyobj__next0 = NULL;
    Mat _next0;
    PyObject* pyobj__flow0 = NULL;
    Mat _flow0;
    double pyr_scale=0;
    int levels=0;
    int winsize=0;
    ...
    const char* keywords[] = { "_prev0", "_next0", "_flow0", "pyr_scale", "levels", "winsize", "iterations", "poly_n", "poly_sigma", "flags", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOdiiiidi:bmcpu_calcOpticalFlowFarneback", (char**)keywords, &pyobj__prev0, &pyobj__next0, &pyobj__flow0, &pyr_scale, &levels, &winsize, &iterations, &poly_n, &poly_sigma, &flags) &&
        pyopencv_to(pyobj__prev0, _prev0, ArgInfo("_prev0", 0)) &&
        pyopencv_to(pyobj__next0, _next0, ArgInfo("_next0", 0)) &&
        pyopencv_to(pyobj__flow0, _flow0, ArgInfo("_flow0", 1)) )
    {
        ERRWRAP2(cv::bmcpu_calcOpticalFlowFarneback(_prev0, _next0, _flow0, pyr_scale, levels, winsize, iterations, poly_n, poly_sigma, flags));
        return pyopencv_from(_flow0);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_calcOpticalFlowPyrLK(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|OOOiOid:bmcpu_calcOpticalFlowPyrLK", (char**)keywords, &pyobj_prevImg, &pyobj_nextImg, &pyobj_prevPts, &pyobj_nextPts, &pyobj_status, &pyobj_err, &pyobj_winSize, &maxLevel, &pyobj_criteria, &flags, &minEigThreshold) &&
        ...
        pyopencv_to(pyobj_criteria, criteria, ArgInfo("criteria", 0)) )
    {
        ERRWRAP2(cv::bmcpu_calcOpticalFlowPyrLK(prevImg, nextImg, prevPts, nextPts, status, err, winSize, maxLevel, criteria, flags, minEigThreshold));
...
static PyObject* pyopencv_cv_bmcpu_circle(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOiO|iii:bmcpu_circle", (char**)keywords, &pyobj_img, &pyobj_center, &radius, &pyobj_color, &thickness, &lineType, &shift) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 1)) &&
        pyopencv_to(pyobj_center, center, ArgInfo("center", 0)) &&
        pyopencv_to(pyobj_color, color, ArgInfo("color", 0)) )
    {
        ERRWRAP2(cv::bmcpu_circle(img, center, radius, color, thickness, lineType, shift));
        return pyopencv_from(img);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_dilate(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OOiiO:bmcpu_dilate", (char**)keywords, &pyobj_src, &pyobj_kernel, &pyobj_dst, &pyobj_anchor, &iterations, &borderType, &pyobj_borderValue) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) &&
    ...
    {
        ERRWRAP2(cv::bmcpu_dilate(src, dst, kernel, anchor, iterations, borderType, borderValue));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_ellipse(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOdddO|iii:bmcpu_ellipse", (char**)keywords, &pyobj_img, &pyobj_center, &pyobj_axes, &angle, &startAngle, &endAngle, &pyobj_color, &thickness, &lineType, &shift) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 1)) &&
        pyopencv_to(pyobj_center, center, ArgInfo("center", 0)) &&
        pyopencv_to(pyobj_axes, axes, ArgInfo("axes", 0)) &&
        pyopencv_to(pyobj_color, color, ArgInfo("color", 0)) )
    {
        ERRWRAP2(cv::bmcpu_ellipse(img, center, axes, angle, startAngle, endAngle, color, thickness, lineType, shift));
        return pyopencv_from(img);
    }
    }
    PyErr_Clear();
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|ii:bmcpu_ellipse", (char**)keywords, &pyobj_img, &pyobj_box, &pyobj_color, &thickness, &lineType) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 1)) &&
        pyopencv_to(pyobj_box, box, ArgInfo("box", 0)) &&
        pyopencv_to(pyobj_color, color, ArgInfo("color", 0)) )
    {
        ERRWRAP2(cv::bmcpu_ellipse(img, box, color, thickness, lineType));
        return pyopencv_from(img);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_erode(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    const char* keywords[] = { "src", "kernel", "dst", "anchor", "iterations", "borderType", "borderValue", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OOiiO:bmcpu_erode", (char**)keywords, &pyobj_src, &pyobj_kernel, &pyobj_dst, &pyobj_anchor, &iterations, &borderType, &pyobj_borderValue) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) &&
        pyopencv_to(pyobj_kernel, kernel, ArgInfo("kernel", 0)) &&
        pyopencv_to(pyobj_anchor, anchor, ArgInfo("anchor", 0)) &&
        pyopencv_to(pyobj_borderValue, borderValue, ArgInfo("borderValue", 0)) )
    {
        ERRWRAP2(cv::bmcpu_erode(src, dst, kernel, anchor, iterations, borderType, borderValue));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_line(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|iii:bmcpu_line", (char**)keywords, &pyobj_img, &pyobj_pt1, &pyobj_pt2, &pyobj_color, &thickness, &lineType, &shift) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 1)) &&
        pyopencv_to(pyobj_pt1, pt1, ArgInfo("pt1", 0)) &&
        pyopencv_to(pyobj_pt2, pt2, ArgInfo("pt2", 0)) &&
        pyopencv_to(pyobj_color, color, ArgInfo("color", 0)) )
    {
        ERRWRAP2(cv::bmcpu_line(img, pt1, pt2, color, thickness, lineType, shift));
        return pyopencv_from(img);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_morphologyEx(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OiO|OOiiO:bmcpu_morphologyEx", (char**)keywords, &pyobj_src, &op, &pyobj_kernel, &pyobj_dst, &pyobj_anchor, &iterations, &borderType, &pyobj_borderValue) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) &&
        pyopencv_to(pyobj_kernel, kernel, ArgInfo("kernel", 0)) &&
        pyopencv_to(pyobj_anchor, anchor, ArgInfo("anchor", 0)) &&
        pyopencv_to(pyobj_borderValue, borderValue, ArgInfo("borderValue", 0)) )
    {
        ERRWRAP2(cv::bmcpu_morphologyEx(src, dst, op, kernel, anchor, iterations, borderType, borderValue));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_putText(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOidO|iib:bmcpu_putText", (char**)keywords, &pyobj_img, &pyobj_text, &pyobj_org, &fontFace, &fontScale, &pyobj_color, &thickness, &lineType, &bottomLeftOrigin) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 1)) &&
        pyopencv_to(pyobj_text, text, ArgInfo("text", 0)) &&
        pyopencv_to(pyobj_org, org, ArgInfo("org", 0)) &&
        pyopencv_to(pyobj_color, color, ArgInfo("color", 0)) )
    {
        ERRWRAP2(cv::bmcpu_putText(img, text, org, fontFace, fontScale, color, thickness, lineType, bottomLeftOrigin));
        return pyopencv_from(img);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_rectangle(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    const char* keywords[] = { "img", "pt1", "pt2", "color", "thickness", "lineType", "shift", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|iii:bmcpu_rectangle", (char**)keywords, &pyobj_img, &pyobj_pt1, &pyobj_pt2, &pyobj_color, &thickness, &lineType, &shift) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 1)) &&
        pyopencv_to(pyobj_pt1, pt1, ArgInfo("pt1", 0)) &&
        pyopencv_to(pyobj_pt2, pt2, ArgInfo("pt2", 0)) &&
        pyopencv_to(pyobj_color, color, ArgInfo("color", 0)) )
    {
        ERRWRAP2(cv::bmcpu_rectangle(img, pt1, pt2, color, thickness, lineType, shift));
        return pyopencv_from(img);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_bmcpu_warpAffine(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|OiiO:bmcpu_warpAffine", (char**)keywords, &pyobj_src, &pyobj_M, &pyobj_dsize, &pyobj_dst, &flags, &borderMode, &pyobj_borderValue) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) &&
        pyopencv_to(pyobj_M, M, ArgInfo("M", 0)) &&
        ...
        pyopencv_to(pyobj_borderValue, borderValue, ArgInfo("borderValue", 0)) )
    {
        ERRWRAP2(cv::bmcpu_warpAffine(src, dst, M, dsize, flags, borderMode, borderValue));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_imdecode(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "buf", "flags", "id", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "Oi|i:imdecode", (char**)keywords, &pyobj_buf, &flags, &id) &&
        pyopencv_to(pyobj_buf, buf, ArgInfo("buf", 0)) )
    {
        ERRWRAP2(retval = cv::imdecode(buf, flags, id));
        return pyopencv_from(retval);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_imread(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "filename", "flags", "id", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|ii:imread", (char**)keywords, &pyobj_filename, &flags, &id) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) )
    {
        ERRWRAP2(retval = cv::imread(filename, flags, id));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_imreadmulti(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "filename", "mats", "flags", "id", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|Oii:imreadmulti", (char**)keywords, &pyobj_filename, &pyobj_mats, &flags, &id) &&
        pyopencv_to(pyobj_filename, filename, ArgInfo("filename", 0)) &&
        pyopencv_to(pyobj_mats, mats, ArgInfo("mats", 1)) )
    {
        ERRWRAP2(retval = cv::imreadmulti(filename, mats, flags, id));
...
static PyObject* pyopencv_cv_freetype_createFreeType2_p(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::freetype;
    ...
    if(PyObject_Size(args) == 0 && (!kw || PyObject_Size(kw) == 0))
    {
        ERRWRAP2(retval = cv::freetype::createFreeType2_p());
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_vpp_border(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::vpp;
    ...
    const char* keywords[] = { "src", "top", "bottom", "left", "right", "dst", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "Oiiii|O:border", (char**)keywords, &pyobj_src, &top, &bottom, &left, &right, &pyobj_dst) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
        ERRWRAP2(cv::vpp::border(src, top, bottom, left, right, dst));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_vpp_crop(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::vpp;
    ...
    PyObject* pyobj__src = NULL;
    Mat _src;
    PyObject* pyobj__loca = NULL;
    vector_Rect _loca;
    PyObject* pyobj__dst = NULL;
    vector_UMat _dst;

    const char* keywords[] = { "_src", "_loca", "_dst", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|O:crop", (char**)keywords, &pyobj__src, &pyobj__loca, &pyobj__dst) &&
        pyopencv_to(pyobj__src, _src, ArgInfo("_src", 0)) &&
        pyopencv_to(pyobj__loca, _loca, ArgInfo("_loca", 0)) &&
        pyopencv_to(pyobj__dst, _dst, ArgInfo("_dst", 1)) )
    {
        ERRWRAP2(cv::vpp::crop(_src, _loca, _dst));
        return pyopencv_from(_dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_vpp_resize(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::vpp;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:resize", (char**)keywords, &pyobj__src, &pyobj__dst) &&
        pyopencv_to(pyobj__src, _src, ArgInfo("_src", 0)) &&
        pyopencv_to(pyobj__dst, _dst, ArgInfo("_dst", 1)) )
    {
        ERRWRAP2(cv::vpp::resize(_src, _dst));
        return pyopencv_from(_dst);
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_vpp_split(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::vpp;
    ...
    const char* keywords[] = { "src", "dst", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:split", (char**)keywords, &pyobj_src, &pyobj_dst) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
        ERRWRAP2(cv::vpp::split(src, dst));
        return pyopencv_from(dst);
    }
    }
    PyErr_Clear();
